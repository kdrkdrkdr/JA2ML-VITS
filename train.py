...
#   n_gpus = 1
  ...
  g_path = hps.model_dir+'/G_0.pth'
  d_path = hps.model_dir+'/D_0.pth'
  utils.download_file(d_path, 'https://github.com/kdrkdrkdr/JA2ML-VITS/releases/download/v1.0/D_0.pth')
  utils.download_file(g_path, 'https://github.com/kdrkdrkdr/JA2ML-VITS/releases/download/v1.0/G_0.pth')
